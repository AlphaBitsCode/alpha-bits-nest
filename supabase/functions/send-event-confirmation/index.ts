        ...
        <body>
          <div class="wrapper">
            ...
            <div class="content">
              ...
              <div class="cta">
                <a href="${eventsUrl}" class="button">View All Events</a>
              </div>
              
              <div class="calendar">
                <p>Add to your calendar:</p>
                <a href="#" class="calendar-link">Google Calendar</a>
                <a href="#" class="calendar-link">Apple Calendar</a>
                <a href="#" class="calendar-link">Outlook</a>
              </div>
              
              <p style="margin-top: 25px;">If you have any questions or need to make changes to your registration, please contact us at <a href="mailto:contact@alphabits.team" style="color: #1e40af; text-decoration: underline;">contact@alphabits.team</a>.</p>
