...
export function HighlightedItemsSection({ items }: HighlightedItemsSectionProps) {
  // Group items by category
  const groupedItems: Record<string, HighlightedItem[]> = {};
      ...
      <div className="container mx-auto px-4">
        ...
        {Object.entries(groupedItems).map(([category, categoryItems]) => (
          <div key={category} className="mb-16">
            <h3 className="text-xl font-bold text-brand-navy mb-6 border-b border-gray-100 pb-2">{category}</h3>
            ...
            {categoryItems.length > 3 && (
              <div className="mt-4 text-right">
                <Link 
                  to={categoryItems[0].type === 'product' ? '/products' : '/services'}
